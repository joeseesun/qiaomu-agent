...
**中文** | [English](#english) · [下载 0.2.1](https://github.com/joeseesun/qiaomu-agent/releases/tag/0.2.1) · [安装方法](#安装) · [反馈问题](https://github.com/joeseesun/qiaomu-agent/issues)
...
当前公开版本为 **0.2.1**，要求 Obsidian **1.11.4 或更新版本**。该版本已提交 Obsidian 社区目录审核；在目录可搜索到之前，请使用 GitHub Release 安装：

1. 从 [0.2.1 Release](https://github.com/joeseesun/qiaomu-agent/releases/tag/0.2.1) 下载同一版本的 `main.js`、`manifest.json`、`styles.css`。
...
**Install:** Download `main.js`, `manifest.json`, and `styles.css` from the same [0.2.1 release](https://github.com/joeseesun/qiaomu-agent/releases/tag/0.2.1). Put them in `<vault>/.obsidian/plugins/qiaomu-agent/`, restart Obsidian, and enable the plugin under Community plugins. Obsidian 1.11.4+ is required. The community directory submission is under review; use the Release until it is searchable there.
