...
import { Check, ChevronDown, ChevronRight, Copy, FileText, History, Plus, SquarePen, Smartphone, X, AlertCircle, CalendarPlus, FilePlus2, Settings2, AtSign, Slash, Paperclip, TextSelect, Sparkles, Shield, FolderPen, ShieldAlert, Pencil, GitBranch, BookOpen, Globe, Newspaper, Shapes } from "lucide-react";
...
interface Props {
  ...
  onConnection: () => void; onNew: () => void; onHistory: (event: MouseEvent) => void; onWechatPreview: () => void;
...
export function ChatPanel(props: Props) {
  ...
  return <>
    <header className="qa-header">
      ...
      <button type="button" onClick={props.onWechatPreview}><Smartphone size={17} /><span className="qiaomu-agent__sr-only">预览当前笔记的公众号排版</span></button>
